...
f2 = open("resultFiles/data/LCMS_data.txt")
for line2 in f2:
...
f1 = open("resultFiles/result/finalRead.txt")
for line1 in f1:
...
#plt.show()
plt.savefig('resultFiles/finalRead.png', dpi = 100)
